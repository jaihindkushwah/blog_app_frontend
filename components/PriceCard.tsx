...
export const PricingHeader = ({
  ...
  <section className="text-center z-50 ">
    <h2 className="text-3xl font-bold dark:text-black">{title}</h2>
    <p className="text-xl pt-1 dark:text-black">{subtitle}</p>
    <br />
  </section>
);
...
export const PricingCard = ({
  ...
  <Card
    // class="rounded-lg border text-card-foreground shadow-sm w-72 flex
    // flex-col justify-between py-1 border-zinc-700 mx-auto sm:mx-0 animate-background-shine bg-white
    // dark:bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%] transition-colors"
    className={cn(
      `w-72 flex flex-col justify-between py-1 hover:scale-105 ease transition-all hover:shadow-lg cursor-pointer ${
